...
@InputType()
class MemberCreateNestedManyWithoutMembershipsInput {
...
export { MemberCreateNestedManyWithoutMembershipsInput as MemberCreateNestedManyWithoutMembershipsInput };
