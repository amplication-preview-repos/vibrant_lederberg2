...
@InputType()
class AppointmentCreateNestedManyWithoutMembersInput {
...
export { AppointmentCreateNestedManyWithoutMembersInput as AppointmentCreateNestedManyWithoutMembersInput };
