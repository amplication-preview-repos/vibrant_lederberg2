...
@InputType()
class AttendanceCreateNestedManyWithoutMembersInput {
...
export { AttendanceCreateNestedManyWithoutMembersInput as AttendanceCreateNestedManyWithoutMembersInput };
